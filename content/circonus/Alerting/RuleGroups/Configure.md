...
![Image: 'ruleset-group3.png'](/assets/ruleset-group3.png?raw=true)
...
![Image: 'ruleset-group-name3.png'](/assets/ruleset-group-name3.png?raw=true)
...
![Image: 'ruleset-group-rules3.png'](/assets/ruleset-group-rules3.png?raw=true)

Once all rulesets are added, you will notice that each metric gets a label; A, B, C, etc.

![Image: 'ruleset-group-rulesadded3.png'](/assets/ruleset-group-rulesadded3.png?raw=true)
...
![Image: 'ruleset-group-threshold4.png'](/assets/ruleset-group-threshold4.png?raw=true)
...
![Image: 'ruleset-group-expression3.png'](/assets/ruleset-group-expression3.png?raw=true)
...
![Image: 'ruleset-group-addcontact3.png'](/assets/ruleset-group-addcontact3.png?raw=true)
...
![Image: 'ruleset-group-final3.png'](/assets/ruleset-group-final3.png?raw=true)
