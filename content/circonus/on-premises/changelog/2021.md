...
* dataless absences should provide a reasonable noit value. (TBD better description)
...
* Bugfix: sending maintenance window changes to the notification service.
* Bugfix: corrects the Apache proxy forwarding rules to accommodate GoAPI proxy
