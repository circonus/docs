...
![Templates are now deprecated in favor of the richer Check and CheckBundle API endpoints.](/assets/template_deprecated.png?raw=true)
...
![Image: 'template_blank_plus3.png'](/assets/template_blank_plus3.png?raw=true)
...
![Image: 'template_add3.png'](/assets/template_add3.png?raw=true)
...
![Image: 'template_blank3.png'](/assets/template_blank3.png?raw=true)
...
![Image: 'template_add_host3.png'](/assets/template_add_host3.png?raw=true)

Select the target host from the list.

![Image: 'template_select_host3.png'](/assets/template_select_host3.png?raw=true)
...
![Image: 'template_add_bundle3.png'](/assets/template_add_bundle3.png?raw=true)

The completed template looks like the image below.

![Image: 'template_complete3.png'](/assets/template_complete3.png?raw=true)
