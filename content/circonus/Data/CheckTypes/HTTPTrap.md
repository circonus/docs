...
![Image: 'check_httptrap_initial3.png'](/assets/check_httptrap_initial3.png?raw=true)

The "JSON Docs" button describes how the JSON you PUT will be parsed into metrics. See [below](/Data/CheckTypes/HTTPTrap.md#HTTPTrapJSONDocs) for more details.
...
![Image: 'check_httptrap_final3.png'](/assets/check_httptrap_final3.png?raw=true)
...
![Image: 'check_httptrap_details3.png'](/assets/check_httptrap_details3.png?raw=true)
...
![Image: 'check_httptrap_change_metrics3.png'](/assets/check_httptrap_change_metrics3.png?raw=true)

This will allow you to select and deselect metrics you want to collect. Click the "Save" button to finalize your choices.

![Image: 'check_httptrap_metrics3.png'](/assets/check_httptrap_metrics3.png?raw=true)
...
In addition to strings and numeric values, values can also be described using ` { "_type": <type>, "_value": <value> } ` syntax. The available types are the same used in [Resmon](/Data/CheckTypes/Resmon.md) (`s, l, L, i, I,` and `n`). Values can be strings or numbers, but are force interpreted pursuant to the type specified. For example,
