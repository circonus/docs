...
### From Releases
1. Download the desired [release version](https://www.github.com/circonus-labs/circonus-irondb-datasource/releases).
...
### From GitHub
1. `git clone https://www.github.com/circonus-labs/circonus-irondb-datasource.git` into plugins directory.
...
This content was sourced from the [README](https://www.github.com/circonus-labs/circonus-irondb-datasource) on GitHub.
